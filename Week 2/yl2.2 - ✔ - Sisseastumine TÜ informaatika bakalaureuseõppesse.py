...
else: # kui oli vähem kui 85 punkti siis läheme edasi
    if punktisumma >= 66 and punktisumma < 85: # vaatame kas punktisumma on suurem ja võrdne 66ga ja väiksem kui 85
        print("Kandideerimine vastuvõtule") # kui jah siis väljendame selle
    else: # kui ei siis liigume edasi
        if punktisumma < 66 and punktisumma >= 0: # vaatame kui punktisumma on väiksem kui 66 ja suurem ja võrdne 0iga
